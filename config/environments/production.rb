Rails3BootstrapDeviseCancan::Application.configure do
 ...
 # config.assets.precompile += %w( DD_belatedPNG.js home.js.coffee carts.js.coffee jquery.tmailsilder.js
  ...
  config.action_mailer.default_url_options = { :host => 'www.cortechino.com' }
  # ActionMailer Config
